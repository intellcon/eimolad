...
Shader "Hidden/MicroSplat/Example_Base1880913319"
{
   Properties
   {
...
_WorldHeightRange("World Height Range", Vector) = (0, 500, 0, 0)
      ...
      _PCHeightHSV("HSV", 2D) = "black" {}
      _PCSlopeGradients("Gradients", 2D) = "grey" {}
      _PCSlopeHSV("HSV", 2D) = "black" {}
   ...
   #pragma fragment Frag
      ...
      #define _PCHEIGHTHSV 1
      #define _PCSLOPEGRADIENT 1
      #define _PCSLOPEHSV 1
